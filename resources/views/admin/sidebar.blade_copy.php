<aside class="main-sidebar sidebar-white-primary    sidebar-no-expand text-sm elevation-4">
                    ...
                    <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('statices.index') }}"
                                class="nav-link  {{ Request::is('dashboard/statices') ? 'bg-success bg-gradient' : '' }} p-1  ">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('delivery.index') }}"
                                class="nav-link  {{ Request::is('dashboard/delivery') ? 'bg-success bg-gradient' : '' }} p-1  ">
 ...
 @if (auth()->user()->id == 7 || auth()->user()->id == 48 || auth()->user()->id == 50)
               @endif
            </ul>
        </nav>
        <!-- /.sidebar-menu -->
